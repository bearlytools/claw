// DO NOT EDIT
// This package is autogenerated and should not be modified expect by the clawc compiler.
...
func (x Maker) XXXEnumGroup() reflect.EnumGroup {
    return XXXPackageDescr.Enums()[0]
}
...
func (x Maker) XXXEnumValueDescr() reflect.EnumValueDescr {
    return XXXPackageDescr.Enums()[0].Get(int(x))
}
    ...
    StructsDescrs: []reflect.StructDescr{
        reflect.XXXStructDescrImpl{
            ...
            FieldList: []reflect.FieldDescr{
                reflect.XXXFieldDescrImpl{FD: mappingCar.ByName("Name")},
                reflect.XXXFieldDescrImpl{FD: mappingCar.ByName("Maker")},
                reflect.XXXFieldDescrImpl{FD: mappingCar.ByName("Year")},
                reflect.XXXFieldDescrImpl{FD: mappingCar.ByName("Serial")},
                reflect.XXXFieldDescrImpl{FD: mappingCar.ByName("Image")},
                reflect.XXXFieldDescrImpl{FD: mappingCar.ByName("PreviousVersions")},
            },
        },  
    },  
}