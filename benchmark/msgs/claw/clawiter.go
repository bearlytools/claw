    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 1: Items
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Items", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 3: VolumeAttributes
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "VolumeAttributes", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
...
func (x PodAffinity) Walk() iter.Seq[clawiter.Token] {
    return func(yield func(clawiter.Token) bool) {
        ...
        {
            list := x.RequiredDuringSchedulingIgnoredDuringExecution()
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "RequiredDuringSchedulingIgnoredDuringExecution", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        {
            list := x.PreferredDuringSchedulingIgnoredDuringExecution()
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "PreferredDuringSchedulingIgnoredDuringExecution", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 0: Volumes
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Volumes", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 1: InitContainers
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "InitContainers", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 2: Containers
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Containers", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 3: EphemeralContainers
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "EphemeralContainers", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 8: NodeSelector
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "NodeSelector", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 17: ImagePullSecrets
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "ImagePullSecrets", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 22: Tolerations
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Tolerations", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 23: HostAliases
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "HostAliases", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 27: ReadinessGates
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "ReadinessGates", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 31: Overhead
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Overhead", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        {
            list := x.TopologySpreadConstraints()
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "TopologySpreadConstraints", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 36: SchedulingGates
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "SchedulingGates", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 37: ResourceClaims
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "ResourceClaims", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 1: Conditions
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Conditions", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 6: HostIps
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "HostIps", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 8: PodIps
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "PodIps", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 10: InitContainerStatuses
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "InitContainerStatuses", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 11: ContainerStatuses
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "ContainerStatuses", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        {
            list := x.EphemeralContainerStatuses()
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "EphemeralContainerStatuses", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 15: ResourceClaimStatuses
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "ResourceClaimStatuses", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 0: MatchExpressions
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "MatchExpressions", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 1: MatchFields
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "MatchFields", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 0: Sources
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Sources", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 0: Limits
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Limits", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 1: Requests
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Requests", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 2: Claims
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Claims", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 9: AllocatedResources
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "AllocatedResources", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 11: VolumeMounts
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "VolumeMounts", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 0: NodeSelectorTerms
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "NodeSelectorTerms", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 0: MatchLabels
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "MatchLabels", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 2: Options
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Options", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 5: Ports
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Ports", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 6: EnvFrom
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "EnvFrom", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 7: Env
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Env", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 9: ResizePolicy
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "ResizePolicy", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 12: VolumeDevices
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "VolumeDevices", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 8: Sysctls
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Sysctls", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 10: Labels
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Labels", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 11: Annotations
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "Annotations", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 12: OwnerReferences
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "OwnerReferences", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
        ...
        // Field 14: ManagedFields
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "ManagedFields", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
    ...
    return func(yield func(clawiter.Token) bool) {
        ...
        // Field 4: HttpHeaders
        {
            ...
            if len(list) == 0 {
                ...
                if !yield(clawiter.Token{Kind: clawiter.TokenListStart, Name: "HttpHeaders", Type: field.FTListStructs, Len: len(list)}) {
                    return
                }
                for _, item := range list {
                    for tok := range item.Walk() {
