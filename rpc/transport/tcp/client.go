...
// NewResolvingDialer creates a TCP dialer with name resolution.
// The target is parsed according to the scheme://authority/endpoint format.
// If no scheme is specified, "passthrough" is used.
//
// Example targets:
//   - "dns:///myservice.namespace:8080" - DNS resolution
//   - "passthrough:///localhost:8080" - Static address
//   - "localhost:8080" - Static address (uses passthrough)
//
