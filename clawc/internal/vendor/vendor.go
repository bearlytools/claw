...
// GetWorkRepo returns the repo path from claw.work.
func (vm *VendorManager) GetWorkRepo() string {
	return vm.work.Repo
}

// GetWorkVendorDir returns the vendor directory name from claw.work.
func (vm *VendorManager) GetWorkVendorDir() string {
	return vm.work.VendorDir
}
