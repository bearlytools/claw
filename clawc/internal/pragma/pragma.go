...
// This file is a copy of the pragma file from github.com/protocolbuffers/protobuf-go.
package pragma
...
// so that it can be extended in the future for any claw language changes.
type DoNotImplement interface{ ClawInternal(DoNotImplement) }
